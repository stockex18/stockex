...
export const metadata: Metadata = {
  ...
  // The real StockEx emblem (generated by public/_gen_admin_icons.py from the
  // same master the user app shows). `apple` is not optional: iOS ignores the
  // manifest's icons and uses apple-touch-icon for "Add to Home Screen". The
  // /broker pages override both with the broker app's own icon.
